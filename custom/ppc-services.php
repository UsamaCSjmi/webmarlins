    ...
    ?>     
            ...
            <div class="main-heading w-100" style="margin: 0;padding: 10px 0;">
                ...
                <div class="home-contact-form w-100">
                    <div class="grid-4-lg grid-2-md grid-1-sm w-100">
                        ...
                        <button class="btn-type-gradient" onclick="ppc_contact()"type="button">Submit</button>
                    </div>
                ...
                <div class="grid-3-lg grid-2-md grid-1-sm">
                    ...
                    <div class="grid-item grid-card" >
                        <div class="service-card-header">
                            <i class="fa-brands fa-google card-service-icon"></i>
                    ...
                    <div class="grid-item grid-card">
                        <div class="service-card-header">
                            <img class="card-service-icon" src="./assets/images/icon_bing.png" alt="Bing">
                            <h5 class="grid-card-heading">
                                Bing Advertising
                            </h5>
                        </div>
                    ...
                    <div class="grid-item grid-card">
                        <div class="service-card-header">
                            <i class="fa-solid fa-cart-shopping card-service-icon"></i>
                            <h5 class="grid-card-heading">
                                E-Commerce Ads
                            </h5>
                        </div>
                    ...
                    <div class="grid-item grid-card">
                        <div class="service-card-header">
                            <i class="fa-brands fa-facebook-f card-service-icon"></i>
                            <h5 class="grid-card-heading">
                    ...
                    <div class="grid-item grid-card">
                        <div class="service-card-header">
                            <i class="fa-solid fa-chart-simple card-service-icon"></i>
                            <h5 class="grid-card-heading">
                                Remarketing
                            </h5>
                        </div>
                    ...
                    <div class="grid-item grid-card">
                        <div class="service-card-header">
                            <i class="fa-brands fa-amazon card-service-icon"></i>
                            <h5 class="grid-card-heading">
                            Amazon Advertising
                            </h5>
                        </div>
        ...
        <section class="why-chose-us section-type-1 w-100 cloud-background">
            ...
            <div class="grid-3-lg grid-2-md grid-1-sm">
                ...
                <div class="grid-item grid-card">
                    <div class="service-card-header">
                        <h5 class="grid-card-heading checked-li">
                            Keyword Research
                        </h5>
                    </div>
                    <div class="grid-card-text">
        ...
        <section class="services-section w-100 grey-background">
            <div class="w-100 grid-4-lg grid-2-md grid-1-sm center-grid pd-20">
                <div class="left-para">
                    <div class="main-heading">
